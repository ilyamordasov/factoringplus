...
function drawViz(data) {
  ...
  const margin = { top: 10, bottom: 20, right: 10, left: 10 };
  ...
  const fillColor =  data.style.barColor.value ? data.style.barColor.value.color : data.style.barColor.defaultValue;
  const highlightColor = data.style.highlightColor.value ? data.style.highlightColor.value.color : data.style.highlightColor.defaultValue;
  const valueColor = data.style.valueColor.value ? data.style.valueColor.value.color : data.style.valueColor.defaultValue;
  const isHighlighted = data.style.enableHighlight.value ? data.style.enableHighlight.value : data.style.enableHighlight.defaultValue;
  ...
  rowData.forEach(function(row, i) {
    ...
    let barHeight = (flag) ? 4 : Math.round((barData["met"] * maxBarHeight) / largestMetric);
